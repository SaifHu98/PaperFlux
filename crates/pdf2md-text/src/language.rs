...
impl LanguageClassifier {
    ...
    fn classify_cjk_family(text: &str) -> (Language, f32) {
        ...
        if text
            .chars()
            .any(|c| matches!(c as u32, 0xAC00..=0xD7AF | 0x1100..=0x11FF))
        {
