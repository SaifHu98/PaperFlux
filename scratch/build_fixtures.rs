...
fn main() {
    ...
    let fixtures = vec![
        ...
        DocDef {
            ...
            pages: vec![
                PageDef {
                    content: "BT\n/F2 18 Tf\n72 710 Td\n(الجريدة الرسمية - قرار رقم 452 لسنة 2026) Tj\n/F1 11 Tf\n0 -25 Td\n(بشأن تنظيم خدمات الحوسبة السحابية والبيانات الحكومية) Tj\n0 -20 Td\n/F2 12 Tf\n(المادة الأولى: التعريفات) Tj\n/F1 10 Tf\n0 -18 Td\n(يقصد بالبيانات الحكومية جميع المعلومات المحفوظة إلكترونيا.) Tj\nET\n".into(),
                },
                PageDef {
                    content: "BT\n/F2 14 Tf\n72 710 Td\n(المادة الثانية: معايير الأمن السيبراني) Tj\n/F1 10 Tf\n0 -22 Td\n(تلتزم كافة الجهات الحكومية بتطبيق التشفير الشامل للبيانات.) Tj\n0 -18 Td\n(يحظر نقل البيانات السرية خارج الحدود الوطنية.) Tj\nET\n".into(),
                },
                PageDef {
                    content: "BT\n/F2 14 Tf\n72 710 Td\n(المادة الثالثة: النفاذ والنشر) Tj\n/F1 10 Tf\n0 -22 Td\n(يعمل بهذا القرار اعتبارا من تاريخ نشره في الجريدة الرسمية.) Tj\n0 -30 Td\n/F2 11 Tf\n(توقيع: رئيس مجلس الوزراء) Tj\nET\n".into(),
                },
            ],
